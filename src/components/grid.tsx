...
export default function Grid({ ...props }: HTMLAttributes<HTMLDivElement>) {
  ...
  return (
    <div
      className="gap-4 grid grid-cols-3 *:bg-[#0095D520] dark:*:bg-[#806EE320] mx-auto px-8 *:p-4 *:rounded-xl max-w-4xl"
      {...props}
    >
      ...
      <div className="*:brightness-0 gap-4 grid grid-cols-2 *:p-4 *:w-full *:aspect-square *:grayscale *:invert-0 dark:*:invert">
